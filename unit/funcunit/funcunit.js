/*
 * Changed by Toni Meuschke at getSelection FN
 *
 * FuncUnit - 2.0.4
 * http://funcunit.com
    ...
    var __m5 = (function(Syn) {
        ...
        // gets the selection of an input or textarea
            getSelection = function( el ) {
                ...
                if (el.type !== "email" && el.type !== "number" &&  el.selectionStart !== undefined ) {
        ...
        h.extend(Syn, {
            ...
            selectText: function( el, start, end ) {
                if ( el.type !== "email" && el.type !== "number" && el.setSelectionRange ) {
                    if (!end ) {
                        el.focus();
