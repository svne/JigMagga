steal("can/control").then(function () {
    ...
    can.Control.extent({
        renderJig: function (configSelector, selector, options) {
            var Controller;
        ...
        browserNotification: function (title, body, icon, onclick) {
    ...
    // TODO: ydFrontend dependent. put into helpers
    can.Control.helper.extend({
